const PrivacyPolicy = () => {
  return (
    <div>
      <div className="cms_title">Privacy Policy</div>
      <div className="cms_content">
        NMS New Moon Studios built the 3VERSE app as a Freemium app. This SERVICE is provided by NMS
        New Moon Studios at no cost and is intended for use as is.
        <br />
        <br />
