const TermsAndCondition = () => {
  return (
    <div>
      <div className="cms_title">Terms and Conditions </div>
      <div className="cms_content">
        ...
        to it, still belong to NMS New Moon Studios. <br />
        <br />
        NMS New Moon Studios is committed to ensuring that the app is as useful and efficient as
        ...
        <br />
        <br /> The 3VERSE app stores and processes personal data that you have provided to us, to
        ...
        programs, compromise your phone’s security features and it could mean that the 3VERSE app
        won’t work properly or at all. <br />
        <br />
        You should be aware that there are certain things that NMS New Moon Studios will not take
        ...
        provider, but NMS New Moon Studios cannot take responsibility for the app not working at
        full functionality if you don’t have access to Wi-Fi, and you don’t have any of your data
        allowance left.
        <br />
        <br /> If you’re using the app outside of an area with Wi-Fi, you should remember that the
        terms of the agreement with your mobile network provider will still apply. As a result, you
        ...
        app outside of your home territory (i.e. region or country) without turning off data
        roaming. If you are not the bill payer for the device on which you’re using the app, please
        be aware that we assume that you have received permission from the bill payer for using the
        app.
        <br />
        <br /> Along the same lines, NMS New Moon Studios cannot always take responsibility for the
        way you use the app i.e. You need to make sure that your device stays charged – if it runs
        out of battery and you can’t turn it on to avail the Service, NMS New Moon Studios cannot
        accept responsibility. With respect to NMS New Moon Studios’s responsibility for your use of
        the app, when you’re using the app, it’s important to bear in mind that although we endeavor
        to ensure that it is updated and correct at all times, we do rely on third parties to
        provide information to us so that we can make it available to you. NMS New Moon Studios
        accepts no liability for any loss, direct or indirect, you experience as a result of relying
        wholly on this functionality of the app. <br />
        <br />
        At some point, we may wish to update the app. The app is currently available on Android &
        iOS – the requirements for the both systems(and for any additional systems we decide to
        extend the availability of the app to) may change, and you’ll need to download the updates
        if you want to keep using the app. NMS New Moon Studios does not promise that it will always
        ...
        <br />
        <br /> Changes to This Terms and Conditions
        <br />
        <br /> We may update our Terms and Conditions from time to time. Thus, you are advised to
        ...
        <br />
        <br /> These terms and conditions are effective as of 2022-09-28 <br />
        <br />
        Contact Us <br />
        <br />
        If you have any questions or suggestions about our Terms and Conditions, do not hesitate to
        contact us at 3VERSE@newmoonstudios.xyz.
      </div>
    </div>
  );
};
