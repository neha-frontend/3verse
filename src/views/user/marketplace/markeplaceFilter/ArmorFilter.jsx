          ...
          <Accordion.Body className="px-0">
            <div className="form-check d-flex align-items-center">
              <input
                ...
                id="head"
                value="head"
                onChange={(e) => handleChange('armor1', e.target.value)}
                checked={!!(filterOptions[`armor1`] === 'head')}
              />
              <label className="marketPlace-filter-checkbox-label" htmlFor="head">
                Head
              </label>
            </div>
            {/* <div className="form-check d-flex align-items-center">
              <input
                ...
                id="shoulder"
                value="shoulder"
                onChange={(e) => handleChange('armor2', e.target.value)}
                checked={!!(filterOptions[`armor2`] === 'shoulder')}
              />
              <label className="marketPlace-filter-checkbox-label" htmlFor="shoulder">
                Shoulder
              </label>
            </div> */}
            <div className="form-check d-flex align-items-center">
              <input
                ...
                id="arm"
                value="arm"
                onChange={(e) => handleChange('armor3', e.target.value)}
                checked={!!(filterOptions[`armor3`] === 'arm')}
              />
              <label className="marketPlace-filter-checkbox-label" htmlFor="arm">
                Arm
              </label>
            </div>
          </Accordion.Body>
